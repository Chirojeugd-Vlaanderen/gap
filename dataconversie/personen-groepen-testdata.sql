...
JOIN adr.Straat s ON ka.Straat COLLATE SQL_Latin1_General_CP1_CI_AI = s.Naam AND ka.PostNr COLLATE SQL_Latin1_General_CP1_CI_AI = cast(s.PostCode as varchar(5))
JOIN adr.Subgemeente sg ON Gemeente COLLATE SQL_Latin1_General_CP1_CI_AI = sg.Naam AND ka.PostNr COLLATE SQL_Latin1_General_CP1_CI_AI = cast(s.PostCode as varchar(5))
