<%@ Page Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="ViewPage<LidAfdelingenModel>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	...
	<fieldset>
		...
		%>
		<p>
			Selecteer afdeling(en) voor
			<%= Model.Info.VolledigeNaam %></p>
		<%
