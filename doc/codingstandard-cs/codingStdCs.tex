...
\noindent {\Large \bf CODING STANDARD C\#, doc. v. 0.6}
...
\item Publieke constanten \index{constanten} worden volledig in UPPER_CASE benoemd en de lettergrepen worden gesplitst met underscores\index{underscores}. Voorbeeld: OFFICIELE_AFDELING_ID
\item Underscores \index{underscores} zijn enkel toegelaten in constanten en als (enkelvoudige) prefix van een member\index{membervariabelen!namen} variable.
...
\item Evalueer of u het beste gebaat bent met een publieke constante of een public static readonly member. Gebruik `\lstinline !const!' enkel voor `echte' constanten, in de
...
namelijk berekend en gesubstitueerd bij het compileren, \lstinline !readonly!-expressies at runtime.} 
\end{enumerate}
