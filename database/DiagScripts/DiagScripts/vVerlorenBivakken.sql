...
-- gebruik hierboven 'bivakoverzicht', an dan heb je er meer.
-- ik vermoed dat groepen waarbij geen contactpersoon/adres opgegeven is bij het bivak
-- wel in bivakaangifte zitten, maar niet in bivakoverzicht.
where gwj.werkjaar=2012 and u.IsBivak=1 and bo.werkjaar is null
