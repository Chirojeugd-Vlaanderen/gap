...
declare @AdFoutePersoon as int; set @AdFoutePersoon= 210357;		-- AD-nummer van dubbele persoon
-- TYPISCH HOOGSTE AD-NUMMER:
declare @AdJuistePersoon as int; set @AdJuistePersoon= 286016;	-- AD-nummer van de persoon met de juiste persoonsgegevens (adressen, contactinfo)
