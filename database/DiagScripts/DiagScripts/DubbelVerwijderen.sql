...
declare @AdFoutePersoon as int; set @AdFoutePersoon=39390;		-- AD-nummer van dubbele persoon
declare @AdJuistePersoon as int; set @AdJuistePersoon=234615;	-- AD-nummer van de persoon met de juiste persoonsgegevens (adressen, contactinfo)
