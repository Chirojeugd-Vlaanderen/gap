...
select g.code, p.adnummer, kr.factuurnr, p.naam, p.voornaam, kp.adnr, l.eindeinstapperiode, kr.facturerenvanaf, l.uitschrijfdatum
from lid.lid l 
...
and kr.doorgeboe='j'
order by g.code, factuurnr, adnummer
