...
begin
	insert into lid.Functie(Naam, Code, MinAantal, MaxAantal, MinLeefTijd, WerkJaarVan, WerkJaarTot) values('Contactpersoon', @gg1Code, 1, 1, 16, 0, 0);
...
begin
	insert into lid.Functie(Naam, Code, MinAantal, MaxAantal, MinLeefTijd, WerkJaarVan, WerkJaarTot) values('Groepsleiding', @gg2Code, 0, 0, 16, 0, 0);
...
begin
	insert into lid.Functie(Naam, Code, MinAantal, MaxAantal, MinLeefTijd, WerkJaarVan, WerkJaarTot) values('VB', @gv1Code, 0, 0, 18, 0, 0);
...
begin
	insert into lid.Functie(Naam, Code, MinAantal, MaxAantal, MinLeefTijd, WerkJaarVan, WerkJaarTot) values('Financieel verantwoordelijke', @fiCode, 1, 1, 16, 0, 0);
...
begin
	insert into lid.Functie(Naam, Code, MinAantal, MaxAantal, MinLeefTijd, WerkJaarVan, WerkJaarTot) values('Vertegenwoordiger in jeugdraad', @jrCode, 0, 0, 16, 0, 0);
...
begin
	insert into lid.Functie(Naam, Code, MinAantal, MaxAantal, MinLeefTijd, WerkJaarVan, WerkJaarTot) values('Contactpersoon kookploeg', @kkCode, 0, 0, 16, 0, 0);
...
begin
	insert into lid.Functie(Naam, Code, MinAantal, MaxAantal, MinLeefTijd, WerkJaarVan, WerkJaarTot) values('Proost', @gpCode, 0, 0, 16, 0, 0);
