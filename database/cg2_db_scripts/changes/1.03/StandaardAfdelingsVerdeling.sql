USE [gap]
GO
/****** Object:  StoredProcedure [data].[spStandaardAfdelingsVerdeling]    Script Date: 12/10/2010 11:36:14 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER procedure [data].[spStandaardAfdelingsVerdeling] (@gwjId as int) as
...
SELECT core.ufnUcFirst(g.Pink_Naam) AS AfdelingsNaam, LEFT(g.Pink_Naam, 3) AS Afkorting, @groepID AS ChiroGroepID FROM kipadmin.dbo.Groep g
WHERE StamNr = @stamNr
	AND g.Verd_Code = 2
