...
namespace Chiro.Gap.Domain
{
	...
	public enum NationaleFunctie
	{
		...
		KookPloeg = 6,
		Proost = 7,
		GroepsLeidingsBijeenkomsten = 190 + 1,
		SomVerantwoordelijke = 190 + 2,
		IkVerantwoordelijke = 190 + 3,
		RibbelVerantwoordelijke = 190 + 4,
		SpeelclubVerantwoordelijke = 190 + 5,
		RakwiVerantwoordelijke = 190 + 6,
		TitoVerantwoordelijke = 190 + 7,
		KetiVerantwoordelijke = 190 + 8,
		AspiVerantwoordelijke = 190 + 9,
		SomGewesten = 190 + 10,
		OpvolgingStadsGroepen = 190 + 11,
		Verbondsraad = 190 + 12,
		Verbondskern = 190 + 13,
		StartDagVerantwoordelijker = 190 + 14,
		SbVerantwoordelijke = 190 + 15
	};
