...
using System.Net;
using Chiro.Cdf.Intranet.Properties;

namespace Chiro.Cdf.Intranet
{
    /// <summary>
    /// Class die voorspelt of een mailadres eruitziet alsof het van de opgegeven eigenaar is
    /// en of het juist geschreven is.
    /// </summary>
    public class Mailadrescontrole : IMailadrescontrole
    {
        // De intranetservice die de eigenlijke controles uitvoert
        MailcontroleService.Mailcontrole _ctrlservice;

        public Mailadrescontrole()
        {
            // Intranetservice instantiëren en credentials meegeven
            _ctrlservice = new MailcontroleService.Mailcontrole();
            _ctrlservice.Credentials = CredentialCache.DefaultCredentials;
        }
        ...
        {
            return !(_ctrlservice.BetrouwbaarheidsscoreOphalenOpNaam(voornaam, naam, email) >= Settings.Default.Minimumscore);
        }
        ...
        {
            return !(_ctrlservice.BetrouwbaarheidsscoreOphalenOpNaamEnGeboortejaar(voornaam, naam, geboortejaar, email) >= Settings.Default.Minimumscore);
        }
        ...
        {
            return _ctrlservice.BetrouwbaarheidsscoreOphalenOpNaam(voornaam, naam, email);
        }
