...
namespace Chiro.Gap.WebApp.Controllers
{
    ...
    // (categorie�n of zo), hebben we steeds een default (categorie, ...) die aangeeft dat alle personen moeten worden meegegeven
    ...
    public class PersonenController : PersonenEnLedenController
    {
        ...
        public ActionResult List([RouteValue]int groepID, [RouteValue]int id)
        {
            ...
            else    // Alleen personen uit de gekozen categorie bekijken
            {
                ...
                // Ga in het lijstje met categorie�n na welke er geselecteerd werd, zodat we de naam in de paginatitel kunnen zetten
        ...
        public ActionResult Nieuw(int groepID)
        {
            ...
            model.CommunicatieTypes =
                ServiceHelper.CallService<IGelieerdePersonenService, IEnumerable<CommunicatieTypeInfo>>(
                    svc => svc.CommunicatieTypesOphalen()).ToDictionary(tc => tc.ID);
            ...
            {
                new CommunicatieInfo {CommunicatieTypeID = (int) CommunicatieTypeEnum.Email, Voorkeur = true},
                new CommunicatieInfo {CommunicatieTypeID = (int) CommunicatieTypeEnum.TelefoonNummer, Voorkeur = true}
            };
        ...
        public ActionResult Kloon(int gelieerdepersoonID, int groepID)
        {
            ...
            model.CommunicatieInfos = new List<CommunicatieInfo>
            {
                new CommunicatieInfo
                {
                    Nummer = broerzus.TelefoonNummer,
        ...
        public ActionResult NieuweCommVorm(NieuweCommVormModel model, int groepID, int id)
        {
            ...
            else
            {
                ...
                // Cache clearen, want mogelijk is er nu een probleem gecre�erd.
                VeelGebruikt.LedenProblemenResetten(groepID);
        ...
        public ActionResult VerwijderenCommVorm(int commvormID, int groepID)
        {
            ...
            // Cache clearen, want mogelijk is er nu een probleem opgelost.
            VeelGebruikt.LedenProblemenResetten(groepID);
        ...
        public ActionResult CommVormBewerken(CommVormModel model, int gelieerdePersoonID, int groepID)
        {
            ...
            // Cache clearen, want mogelijk is er nu een probleem opgelost of gecre�erd.
            VeelGebruikt.LedenProblemenResetten(groepID);
        ...
        /// categorie�n met ID's <paramref name="model"/>.GeselecteerdeCategorieIDs
        /// </summary>
        /// <param name="model"><c>CategorieModel</c> met ID's van gelieerde personen en categorie�n</param>
