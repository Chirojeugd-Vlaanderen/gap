...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%= Html.CheckBoxFor(mdl => mdl.PersoonLidInfo.PersoonDetail.NieuwsBrief) %> Stuur <%:Model.PersoonLidInfo.PersoonDetail.VolledigeNaam %> e-mail van de Chiro op <%=Html.EditorFor(mdl => mdl.EmailAdres) %>.
        <br/>
