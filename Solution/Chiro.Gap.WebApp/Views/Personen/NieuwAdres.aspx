...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <fieldset>
        ...
        <label for="NieuwAdres_Straat_Naam">
            Straat</label>
        <%=Html.TextBox("NieuwAdres.Straat.Naam") %>
        <%= Html.ValidationMessage("NieuwAdres.Straat.Naam") %>
        <br />
        <label for="NieuwAdres_HuisNr">
            Nr.</label>
        <%=Html.TextBox("NieuwAdres.HuisNr") %>
        <br />
        <label for="NieuwAdres_Straat_PostNr">
            Postnr.</label>
        <%=Html.TextBox("NieuwAdres.Straat.PostNr") %>
        <br />
        <label for="NieuwAdres_Subgemeente_Naam">
            Gemeente</label>
        <%=Html.TextBox("NieuwAdres.Subgemeente.Naam") %>
        <%= Html.ValidationMessage("NieuwAdres.Subgemeente.Naam") %>
        <br />
