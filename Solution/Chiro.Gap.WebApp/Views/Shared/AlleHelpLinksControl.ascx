...
<div id="helpmenu">
	...
	<ul>
		...
		<li>
			<%=Html.ActionLink("Adres", actie, new { Controller = "Handleiding", helpBestand = "NieuwAdres" }) %></li>
		<li>
			<%=Html.ActionLink("Straatnaam", actie, new { Controller = "Handleiding", helpBestand = "NieuweStraatnaam" }) %></li>
	</ul>
	<p>
	...
	<p>
		Gegevens opzoeken en gebruiken:</p>
	<ul>
		<li>
			<%=Html.ActionLink("Overzichten filteren", actie, new { Controller = "Handleiding", helpBestand = "Filteren" })%></li>
		<li>
			<%=Html.ActionLink("Lijsten downloaden", actie, new { Controller = "Handleiding", helpBestand = "LijstDownloaden" })%></li>
		<li>
			<%=Html.ActionLink("Etiketten maken", actie, new { Controller = "Handleiding", helpBestand = "EtikettenMaken" })%></li>
	</ul>
</div>