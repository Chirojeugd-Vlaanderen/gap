...
<asp:Content ID="Content2" ContentPlaceHolderID="HelpContent" runat="server">
    <h2>Een nieuwe persoon toevoegen</h2>
    <p>
    ...
    <ul>
        ...
        <img src="<%=ResolveUrl("~/Content/Screenshots/Werkbalk_PersoonToevoegen.png") %>"
            alt="Tabblad nieuwe persoon" />
    ...
    <ul>
        <li>Vul de gevraagde gegevens in en klik op de knop 'Bewaren'
			<ul>
                <li>Je moet minstens een voornaam, naam, geboortedatum, het geslacht en een adres invullen,
                    je kan de persoon ook meteen inschrijven door onder 'Chirogegevens' op 'Ja' te klikken.
                    Je krijgt dan het volgende scherm te
                    zien, waar je de afdeling kan kiezen.</li>
                <img src="<%=ResolveUrl("~/Content/Screenshots/Tabblad_NieuwePersoon_Inschrijven.png") %>"
                    alt="Persoon inschrijven" />
                <li>Als er iets foutliep, krijg je daar een foutmelding voor zodat je nog zaken
					kunt aanpassen. Het kan bv. zijn dat je iemand dubbel probeert toe te voegen of
                    dat je te weinig gegevens invulde.</li>
                <li>Als er geen problemen meer zijn, kom je terecht op de persoonsfiche van de persoon
                    die je net toevoegde.</li>
            </ul>
        </li>
    </ul>
    ...
    <ul>
        <li>Bijkomende gegevens die je kunt toevoegen:
			<ul>
                ...
                <li>Extra telefoonnummer(s), mailadres(sen), enz.</li>
                <li>Categorieën</li>
            </ul>
        </li>
    </ul>
    <p>
        Voeg zeker een adres toe als die persoon lid moet worden van je groep. Vanaf dan
        kun je hem of haar inschrijven.
    </p>
</asp:Content>
