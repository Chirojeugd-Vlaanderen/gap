...
<asp:Content ID="Content2" ContentPlaceHolderID="HelpContent" runat="server">
	...
	<ul>
		...
		<li>Vul de naam en een afkorting (code) in. Geef op hoeveel mensen in je groep die
			functie mogen hebben (maximum), hoeveel er ze moeten hebben (minimum). Het jaartal
			mag normaal gezien leeg blijven. Vul het bijvoorbeeld in als je ledenlijsten
			van voorbije werkjaren wilt filteren op functie en je wilt de nieuwe functie
			daar niet bij zien staan voor ze ingevoerd werd. Ten slotte moet je nog aanduiden
			of alleen leiding de functie kan hebben, of alleen leden, of allebei.
			<ul>
