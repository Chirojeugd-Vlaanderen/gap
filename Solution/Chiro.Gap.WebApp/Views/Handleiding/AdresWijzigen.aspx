...
<asp:Content ID="Content2" ContentPlaceHolderID="HelpContent" runat="server">
    <div id="verhuizen">
        ...
        <ul>
            ...
            <li>Klik daar op het <strong>'pen'-icoon</strong> achter het adres dat je wilt aanpassen.</li>
        </ul>
        <img src="<%=ResolveUrl("~/Content/Screenshots/AdresWijzigen_pen.png") %>" alt="De persoonlijkegegevensfiche" />
        <ul>
            <li>Er verschijnt een venster waarin de gegevens aangepast kunnen worden. Wonen er meerdere mensen op dat adres, dan vind je hun namen bovenaan. Doe het vinkje eventueel weg bij mensen die niet mee verhuizen.</li>
        </ul>
		...
		<%= Html.ActionLink("vragen aan het nationaal secretariaat dat ze de straatnamenlijst aanvullen", 
			"ViewTonen", new { controller = "Handleiding", helpBestand = "NieuweStraatnaam" })%>.
        </p>
    </div>
</asp:Content>
