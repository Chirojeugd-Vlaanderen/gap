...
<asp:Content ID="Content2" ContentPlaceHolderID="HelpContent" runat="server">
	...
	<ul>
		...
		<li>Klik op de knop 'Afdruk samenvoegen starten' en kies 'Etiketten'. Selecteer
			in het venstertje het merk en formaat van je etiketten. (De meest gebruikte
		...
		<li>Klik in de ribbon op de knop 'Adressen selecteren' en kies 'Bestaande lijst
			selecteren'. Je krijgt dan een venstertje waarmee je de gedownloade lijst opzoekt.</li>
		<li>Heb je het bestand geselecteerd en op de knop 'Openen' geklikt, dan krijg je
			...
			staan (er is er maar één) en één waarin je een voorbeeld kunt zien van je gegevens.
			Klik op 'OK' om verder te gaan.</li>
		<li>Nu staat er een tabel op je blad, met in elke cel de tekst &lt;&lt;Volgende
			...
			kolommen. Zet de nodige gegevens in je etiket en typ er de nodige spaties en
			nieuwe regels bij.</li>
