...
<asp:Content ID="Content2" ContentPlaceHolderID="HelpContent" runat="server">
    ...
    <ul>
        ...
        <li><a href="#LateInschrijving">Onze inschrijvingsdag is kort voor/na de deadline van
            15 oktober. Wat nu?</a></li>
        <li><a href="#Bestandsprobleem">Ik kan wel lijsten downloaden, maar ik krijg ze niet
            open.</a></li>
    ...
    <h3>
        <a class="anchor" id="BivakaangifteInOrde">Hoe weet ik of mijn bivakaangifte in orde
            is?</a></h3>
    <p>
        Je kunt dat zelf controleren. Zie je op het tabblad 'Uitstappen/bivak' in het lijstje
        je kamp staan? Staat er een vinkje in de kolom 'bivak'? En als je naar de deelnemerslijst
        kijkt, vind je daar dan een contactpersoon op? (Die staat in het vet, en er staat
        geen link bij 'contact maken'.) In orde!</p>
    <h3>
        <a class="anchor" id="Bivakverzekering">Hoe weet ik of iedereen die meegaat op bivak
            verzekerd is?</a></h3>
    <p>
        Ingeschreven leden, leiders en leidsters zijn sowieso verzekerd. Bij hen staat er
        op de deelnemerslijst 'lid' of 'leiding'. Staat er '???', dan moet je hen nog inschrijven
        in je groep. Logistiek medewerk(st)ers zijn verzekerd als ze aangesloten zijn, anders
        heb je een verzekering voor een beperkte periode nodig (zie <a href="http://www.chiro.be/verzekeringen">
    ...
    <p>
        Je moet daarvoor niet bellen of mailen naar het nationaal secretariaat: als je de
        jaarovergang pas uitvoerde, wéten wij dat niet. De gegevens worden namelijk pas
        na de instapperiode van de eerst ingeschrevenen doorgestuurd. Je kunt het wel zelf
        controleren: bovenaan zie je het juiste (nieuwe) werkjaar, en op het tabblad 'Ingeschreven'
    ...
    <p>
        ...
        Je mag geen afdeling hebben voor leden die jonger zijn dan 6 jaar (zie <a href="http://www.chiro.be/minimumleeftijd"
            title="Uitleg over de minimumleeftijd voor Chiroleden">de Chirosite</a>). Als
        het daar niet aan ligt, heb je waarschijnlijk leden die te jong zijn. Schrijf hen
        uit en probeer de jaarovergang opnieuw uit te voeren. Lukt het nog niet? Neem dan
        contact op met <a href="http://www.chiro.be/eloket/feedback-gap">de helpdesk</a>.</p>
    <h3>
        <a class="anchor" id="WieVerzekerd">Hoe kan ik zien wie er allemaal verzekerd is?</a></h3>
    <p>
        Iedereen die op het tabblad 'Ingeschreven' staat, is verzekerd. Ook al is hun instapperiode
        nog niet voorbij en zijn de gegevens dus nog niet doorgestuurd naar het nationaal
        secretariaat.</p>
    <h3>
        <a class="anchor" id="WieAangesloten">Hoe kan ik zien wie er allemaal aangesloten is?</a></h3>
    <p>
        Iedereen die op het tabblad 'Ingeschreven' staat en niet meer in hun instapperiode
        zit, is aangesloten. De aansluiting geldt wel voor een heel werkjaar. Mensen die
        je uitschrijft, staan niet meer op het tabblad 'Ingeschreven', maar ze blijven wel
        aangesloten. Als je hen achteraf dus opnieuw inschrijft, krijg je geen nieuwe factuur.</p>
    <h3>
    ...
    <p>
        ...
        Die datum is al jaren een deadline: voor de verzekeringen, én voor de werking van
        het nationaal secretariaat. Dat zijn zaken waar we geen risico mee willen nemen.</p>
    <p>
        Dat betekent niet dat je ledenlijst al volledig in orde moet zijn. Twijfelgevallen
        schrijf je uit (bij voorkeur nog voor de jaarovergang), nieuwe leden kun je nog
        het hele jaar toevoegen.</p>
    <h3>
        <a class="anchor" id="LateInschrijving">Onze inschrijvingsdag is kort voor/na de deadline
            van 15 oktober. Wat nu?</a></h3>
    <p>
        Op 15 oktober moet de jaarovergang uitgevoerd zijn. Dat betekent niet dat je leden
        allemaal aangesloten worden op die dag. Doe je de jaarovergang op 14 oktober, dan
        krijgen je automatisch ingeschreven leden een instapperiode
    ...
    <h3>
        <a class="anchor" id="Bestandsprobleem">Ik kan het bestand wel downloaden, maar ik krijg
            het niet open.</a></h3>
    <p>
        De lijsten die je kunt downloaden, zijn opgemaakt in het formaat van Office 2007.
        Als je Office 2003 hebt en je krijgt het bestand niet open, dan moet je eerst een
        <a href="http://www.microsoft.com/downloads/details.aspx?familyid=941b3470-3ae9-4aee-8f43-c6bb74cd1466&displaylang=nl"
            title="Hulpprogramma om Office 2007-bestanden te kunnen openen in Office 2003">extra
            programma</a> installeren. Zorg ook dat je <a href="http://update.microsoft.com">de
                recentste updates van Office</a> geïnstalleerd hebt.</p>
    <p>
    ...
    <p>
        ...
        extra kolommen in kunnen komen. De opmaak kunnen we niet veranderen: die is verschillend
        in verschillende programma's en voor verschillende printers. Het is dus de bedoeling
        dat je dat bestand zelf nog aanpast. Voor gevorderden: met macro's kun je dat wel
        wat automatiseren.</p>
    <h3>
