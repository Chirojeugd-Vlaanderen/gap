...
<asp:Content ID="Content2" ContentPlaceHolderID="HelpContent" runat="server">
    ...
    <dl class="Woordenlijst">
        ...
        <dd id="AANINFO">Je bent aangesloten bij Chirojeugd Vlaanderen wanneer een groep, gewest,
            verbond
            of nationale vrijwilligersploeg je inschrijft en je instapperiode<%=Html.InfoLink("TW_Instap1") %>
            is verstreken. Een inschrijving kan ongedaan gemaakt worden in de loop
        ...
        <dd id="ADINFO">Iedereen die in de administratie van het nationaal Chirosecretariaat
            terechtkomt,
        ...
        <dd id="BIVINFO">Jeugudbewegingen gaan elk jaar in de zomer op kamp. In de Chiro noemen
            we dat ook
            ...
            een bivakaangifte<%=Html.InfoLink("TW_BivakAangifte1") %> voor doen. Alle info over
            verzekeringen,
        ...
        <dd id="BAINFO">Voor 1 juni moet je de gegevens van je bivakplaats doorgeven aan het
            ...
            gegevens worden doorgegeven, de deelnemerslijst is alleen voor jouw groep zichtbaar.
        </dd>
        <dt><strong><a class="anchor" id="Categorie">Categorie</a></strong>:</dt>
        <dd id="CATINFO">Een categorie is een label dat je zelf kunt kiezen. Geef ze een naam
            (bv. 'kookploeg')
        ...
        <dd id="CLINFO">Bij de jaarovergang worden leden automatisch in de afdeling gestopt
            die overeenkomt
        ...
        <dd id="CPINFO">De contactpersoon is degene die de post van het nationaal secretariaat
            zal ontvangen.</dd>
        <dt><strong><a class="anchor" id="Factuur">Factuur</a></strong>:</dt>
        <dd id="FACINFO">Op geregelde tijdstippen verzamelt het nationaal secretariaat alle
            bewerkingen die
        ...
        <dt><strong><a class="anchor" id="FinancieelVerantwoordelijke">Financieel verantwoordelijke</a></strong>:
        </dt>
        <dd id="FVINFO">De financieel verantwoordelijke is degene naar wie de facturen opgestuurd
            worden.</dd>
        <dt><strong><a class="anchor" id="GAV">GAV</a></strong>:</dt>
        <dd id="GAVINFO">Groepsadministratieverantwoordelijke. Aangezien jij deze website gebruikt,
            ben je
        ...
        <dd id="MVXINFO">De Chiro erkent het derde geslacht. Naast man en vrouw kun je dus ook
            voor X kiezen.
			Dat wordt bijvoorbeeld toegekend aan baby's van wie niet direct duidelijk is wat
            het geboortegeslacht is.
			Dat kan later dan nog aangepast worden, bijvoorbeeld wanneer door de puberteit de
            secundaire geslachtskenmerken 
			meer duidelijkheid geven. Mensen die zich noch man noch vrouw voelen, of beide,
            kunnen zelf voor dat derde geslacht 
			kiezen. Iemand die een operatie of behandeling ondergaat om zijn of haar uiterlijk
            in overeenstemming te brengen 
			met zijn of haar genderidentiteit zal waarschijnlijk niet voor X kiezen maar voor
            man of vrouw. Laat het aan de 
			mensen in kwestie (of hun ouders) over om dat label te kiezen, en respecteer die
            keuze. Meer info: <a href="http://genderklik.be/Levenslooplijn/Welkomopdeplaneetrozeblauw.aspx">
                genderklik.be</a>.
        <dt><strong><a class="anchor" id="GezinsgebondenCommunicatievorm">Gezinsgebonden communicatievormen</a></strong>:
        </dt>
        <dd id="GB-COMINFO">Een communicatievorm is bijvoorbeeld een telefoonnummer of een mailadres.
            Je kunt
        ...
        <dd id="INSCHRINFO">Mensen die je inschrijft, maak je lid van je groep. Je vindt hen
            op het tabblad
            ...
            opmaken.</dd>
        <dt><strong><a class="anchor" id="Inschrijvingsvoorwaarden">Inschrijvingsvoorwaarden</a></strong>:
        </dt>
        <dd id="INSCHR-VWINFO">Je kunt enkel mensen inschrijven die aan alle voorwaarden voldoen,
            dus zie je in
        ...
        <dd id="INSINFO">Iedereen die je inschrijft in je groep krijgt een instapperiode. De
            einddatum vind
        ...
        <dd id="JOINFO">Tijdens de jaarovergang geef je aan welke afdelingen je groep heeft.
            De leden van
        ...
        <dd id="LUINFO">Chirojeugd Vlaanderen maakt verschillende publicaties voor leden. Voor
            de jongste
        ...
        <dd id="LIDINFO">Een persoon die ingeschreven is in de groep en (na de instapperiode<%=Html.InfoLink("TW_Instap4") %>)
            dus aangesloten<%=Html.InfoLink("TW_Aansluiting") %> bij Chirojeugd Vlaanderen
        </dd>
        <dt><strong><a class="anchor" id="Lidgeld">Lidgeld</a></strong>:</dt>
        <dd id="LGINFO">Op de persoonsfiche van ingeschreven leden kun je aanduiden of zij hun
            lidgeld al
        ...
        <dt><strong><a class="anchor" id="LogistiekMedewerkers">Logistiek medewerk(st)ers</a></strong>:
        </dt>
        <dd id="LMINFO">Je kunt op uitstappen<%=Html.InfoLink("TW_Uitstap1") %> en bivakken<%=Html.InfoLink("TW_Bivak") %>
            ...
            Die mensen vallen ook automatisch onder de Chiroverzekering, je moet hen dus niet
            aansluiten of apart verzekeren.
        </dd>
        <dt><strong><a class="anchor" id="Nieuwsbrief">Nieuwsbrief</a></strong>:</dt>
        <dd id="SBLINFO">Je kunt je via het GAP inschrijven voor de maandelijkse Chiro-nieuwsbrief
            met nieuws, info
            en weetjes voor Chiroleiding.</dd>
        <dt><strong><a class="anchor" id="Persoon">Persoon</a></strong>:</dt>
        <dd id="PERINFO">In deze handleiding bedoelen we met een persoon om het even wie van
            wie je gegevens
        ...
        <dd id="UITSCHRINFO">Iemand uitschrijven is een drastische maatregel. In principe kan
            het ook niet -
            ...
            <%=Html.ActionLink("Hoe doe je dat?", "ViewTonen", new { controller = "Handleiding", helpBestand = "Uitschrijven" })%>
        </dd>
        <dt><strong><a class="anchor" id="Uitstap">Uitstap</a></strong>:</dt>
        <dd id="UITINFO">Ga je op weekend met je afdeling, naar het zwembad met heel de groep,
            of op bivak?
