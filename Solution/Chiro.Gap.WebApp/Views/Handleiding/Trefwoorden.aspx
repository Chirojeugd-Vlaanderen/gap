...
<asp:Content ID="Content2" ContentPlaceHolderID="HelpContent" runat="server">
	<h2>
		Trefwoorden</h2>
	<ul class="Woordenlijst">
		<li><b><a class="anchor" id="AD-nummer">AD-nummer</a></b>: iedereen die in de administratie
			van het nationaal Chirosecretariaat terechtkomt, krijgt een administratief identificatienummer.
			Je hebt dat nodig als je bepaalde zaken wilt op-of aanvragen, en Chirojeugd
			Vlaanderen gebruikt het om je makkelijk terug te vinden.</li>
		<li><b><a class="anchor" id="Categorie">Categorie</a></b>: een categorie is een
			label dat je zelf kunt kiezen. Geef ze een naam (bv. 'kookploeg') en een afkorting
			(bv. 'KP' of 'kok'). Mensen die je aan een categorie toevoegt, kun je makkelijk
			terugvinden door in het personenoverzicht (klik bovenaan rechts op 'Iedereen')
			te selecteren op categorie.</li>
		<li><b><a class="anchor" id="Chiroleeftijd">Chiroleeftijd</a></b>: bij de jaarovergang
			worden leden automatisch in de afdeling gestopt die overeenkomt met hun geboortejaar.
		...
		<li><b><a class="anchor" id="Factuur">Factuur</a></b>: op geregelde tijdstippen
			...
			en bijkomende verzekeringen. De prijs van zo'n bewerking staat altijd ergens
			vermeld - zo kom je niet voor verrassingen te staan.</li>
		<li><b><a class="anchor" id="GAV">GAV</a></b>: groepsadministratieverantwoordelijke.
			Aangezien jij deze website gebruikt, ben je een GAV van jouw groep. Een groep
			kan zoveel GAV's hebben als je zelf wilt. Ze moeten wel allemaal een eigen login
			hebben voor deze website.</li>
		<li><b><a class="anchor" id="GezinsgebondenCommunicatievorm">Gezinsgebonden communicatievormen</a></b>:
			een communicatievorm is bijvoorbeeld een telefoonnummer of een mailadres. Je
			...
			als gezinsgebonden voor je leden.</li>
		<li><b><a class="anchor" id="Inschrijvingsvoorwaarden">Inschrijvingsvoorwaarden</a></b>:
			je kunt enkel mensen inschrijven die aan alle voorwaarden voldoen, dus zie je
		...
		<li><b><a class="anchor" id="Ledenuitgave">Ledenuitgave</a></b>: Chirojeugd Vlaanderen
			...
			afdeling dezelfde publicatie.</li>
		<li><b><a class="anchor" id="Lid">Lid</a></b>: een persoon die ingeschreven is in
			de groep en dus aangesloten bij Chirojeugd Vlaanderen</li>
		<li><b><a class="anchor" id="Lidgeld">Lidgeld</a></b>: op de persoonsfiche van ingeschreven
			leden kun je aanduiden of zij hun lidgeld al betaald hebben. Dat is informatie
			voor je groep, niet voor het nationaal secretariaat. Lidgeld is wat je leden
		...
		<li><b><a class="anchor" id="Persoon">Persoon</a></b>: in deze handleiding bedoelen
			...
			moeten worden in je groep: je leden en je leiding. Maar je kunt ook andere (contact)gegevens
			bijhouden: van je kookploeg, oud-leiding, contactpersonen uit de jeugdraad of
			het parochieteam, noem maar op. Die informatie is dan ineens beschikbaar voor
		...
		<li><b><a class="anchor" id="Snelleberichtenlijsten">Snelleberichtenlijsten</a></b>:
			...
			VB's en jeugdraadvertegenwoordigers. Meer info vind je <a href="http://www.chiro.be/Snelleberichtenlijst">
				op de Chirosite</a>.</li>
		<li><b><a class="anchor" id="Voorkeursadres">Voorkeursadres</a></b>: elke persoon
			kan verschillende adressen hebben, van verschillende types (thuis, kot, enz.).
			Het voorkeursadres is waar de post moet aankomen. Dat is dus het adres dat in
			het Excel-bestand staat dat je kunt downloaden, en dat doorgestuurd wordt naar
			het nationaal secretariaat op het moment dat je aangesloten wordt.</li>
	</ul>
</asp:Content>
