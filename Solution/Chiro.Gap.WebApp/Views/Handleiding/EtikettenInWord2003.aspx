...
<asp:Content ID="Content2" ContentPlaceHolderID="HelpContent" runat="server">
	...
	<img src="<%=ResolveUrl("~/Content/Screenshots/word2003_etiketten06.png") %>"
		alt="Het Excel-bestand opzoeken" /><% // TODO (#649): screenshot maken en toevoegen %>
	<img src="<%=ResolveUrl("~/Content/Screenshots/word2003_etiketten07.png") %>"
		alt="Het juiste werkblad selecteren" /><% // TODO (#649): screenshot maken en toevoegen %>
	<img src="<%=ResolveUrl("~/Content/Screenshots/word2003_etiketten08.png") %>"
		alt="Een voorbeeld van de gegevens" /><% // TODO (#649): screenshot maken en toevoegen %>
	<ul>
