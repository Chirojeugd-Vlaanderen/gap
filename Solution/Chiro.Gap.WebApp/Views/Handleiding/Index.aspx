...
<asp:Content ID="Content2" ContentPlaceHolderID="helpContent" runat="server">
    <% 
        ...
        if (DateTime.Now.Month > 4 && DateTime.Now.Month <= 8)
        { %>
    <h2>
    ...
    <p>
        De GAV's van jouw groep moeten de volgende zaken uitvoeren om je aansluiting in
        orde te brengen:</p>
    <ul>
    ...
    <p>
        Als er zaken zijn die je zo snel mogelijk in orde moet brengen, dan krijg je daar
        onderaan rechts op je scherm een kadertje met een waarschuwing voor.</p>
    <p>
        Als je in de handleiding een link ziet staan die uit één of meerdere woorden bestaat,
        dan verwijst die naar een ander onderdeel van de handleiding of naar een externe
        website. Als er [?] staat, dan verwijst die link naar een trefwoord dat uitgelegd
        wordt in de handleiding.</p>
    <p>
        Vragen of feedback? <a href="http://www.chiro.be/eloket/feedback-gap">Laat maar komen!</a></p>
    <p>
        Je kunt discussiëren over hoe handig het systeem wel of niet is, en je kunt elkaar
        helpen om het te leren gebruiken: op het <a href="http://forum.chiro.be/forum/144">Chiroforum</a>.</p>
    <p>
