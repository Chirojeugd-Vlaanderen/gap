...
<asp:Content ID="Content2" ContentPlaceHolderID="HelpContent" runat="server">
    ...
    <h3>Wat kun je hier zien?</h3>
    <p>
        Op deze pagina zie je alle persoonsgebonden gegevens: adres, telefoonnummer(s),
		mailadres(sen), categorieën, enz.
    </p>
    <p>
        Gaat het om iemand die ingeschreven is dit werkjaar, dan zie je ook lidgegevens:
		heeft hij of zij al lidgeld betaald, wanneer verstrijkt de instapperiode<%=Html.InfoLink("INSINFO") %>,
		welke functies heeft hij of zij en in welke afdeling zit hij of zij.
    </p>
    ...
    <ul>
        <li>
			...
			geslacht, geboortedatum, Chiroleeftijd<%=Html.InfoLink("CLINFO") %></li>
        <li>
