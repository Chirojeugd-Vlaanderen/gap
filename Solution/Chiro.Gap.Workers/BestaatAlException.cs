...
namespace Chiro.Gap.Workers.Exceptions
{
    ...
    public class BestaatAlException<TEntiteit> : GapException where TEntiteit : IBasisEntiteit
    {
        ...
        /// </param>
        public BestaatAlException(string message, Exception innerException) : base(message, innerException)
        {
        }
        ...
        /// De streamingcontext
        /// </param>
        protected BestaatAlException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
            if (info == null)
            {
                return;
        ...
        /// </param>
        public BestaatAlException(TEntiteit entiteit) : this(null, null)
        {
            _bestaande = entiteit;
        }
