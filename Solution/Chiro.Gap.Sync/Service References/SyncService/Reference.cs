...
namespace Chiro.Gap.Sync.SyncService {
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Runtime.Serialization", "4.0.0.0")]
    [System.Runtime.Serialization.DataContractAttribute(Name="Bivak", Namespace="http://schemas.datacontract.org/2004/07/Chiro.Kip.ServiceContracts.DataContracts")]
    [System.SerializableAttribute()]
    public partial class Bivak : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        
        [System.NonSerializedAttribute()]
        private System.Runtime.Serialization.ExtensionDataObject extensionDataField;
        
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private System.DateTime DatumTotField;
        ...
        public string Opmerkingen {
            ...
            set {
                if ((object.ReferenceEquals(this.OpmerkingenField, value) != true)) {
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public int UitstapID {
            get {
                return this.UitstapIDField;
            }
            set {
                if ((this.UitstapIDField.Equals(value) != true)) {
                    this.UitstapIDField = value;
                    this.RaisePropertyChanged("UitstapID");
                }
            }
        }
    ...
    public interface ISyncPersoonService {
        ...
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/ISyncPersoonService/LidVerwijderen")]
        void LidVerwijderen(int adNummer, string stamNummer, int werkjaar);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/ISyncPersoonService/NieuwLidVerwijderen")]
        void NieuwLidVerwijderen(Chiro.Gap.Sync.SyncService.PersoonDetails details, string stamNummer, int werkjaar);
        ...
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/ISyncPersoonService/BivakBewaren")]
        void BivakBewaren(Chiro.Gap.Sync.SyncService.Bivak bivak);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/ISyncPersoonService/BivakPlaatsBewaren")]
        void BivakPlaatsBewaren(int uitstapID, string plaatsNaam, Chiro.Gap.Sync.SyncService.Adres adres);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/ISyncPersoonService/BivakContactBewaren")]
        void BivakContactBewaren(int uitstapID, int adNummer);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/ISyncPersoonService/BivakContactBewarenAdOnbekend")]
        void BivakContactBewarenAdOnbekend(int uitstapID, Chiro.Gap.Sync.SyncService.PersoonDetails details);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/ISyncPersoonService/BivakVerwijderen")]
    ...
    public partial class SyncPersoonServiceClient : System.ServiceModel.ClientBase<Chiro.Gap.Sync.SyncService.ISyncPersoonService>, Chiro.Gap.Sync.SyncService.ISyncPersoonService {
        ...
        public void LidVerwijderen(int adNummer, string stamNummer, int werkjaar) {
            base.Channel.LidVerwijderen(adNummer, stamNummer, werkjaar);
        }
        
        public void NieuwLidVerwijderen(Chiro.Gap.Sync.SyncService.PersoonDetails details, string stamNummer, int werkjaar) {
            base.Channel.NieuwLidVerwijderen(details, stamNummer, werkjaar);
        }
        ...
        public void BivakBewaren(Chiro.Gap.Sync.SyncService.Bivak bivak) {
            base.Channel.BivakBewaren(bivak);
        }
        
        public void BivakPlaatsBewaren(int uitstapID, string plaatsNaam, Chiro.Gap.Sync.SyncService.Adres adres) {
            base.Channel.BivakPlaatsBewaren(uitstapID, plaatsNaam, adres);
        }
        
        public void BivakContactBewaren(int uitstapID, int adNummer) {
            base.Channel.BivakContactBewaren(uitstapID, adNummer);
        }
        
        public void BivakContactBewarenAdOnbekend(int uitstapID, Chiro.Gap.Sync.SyncService.PersoonDetails details) {
            base.Channel.BivakContactBewarenAdOnbekend(uitstapID, details);
        }
        
        public void BivakVerwijderen(int uitstapID) {
            base.Channel.BivakVerwijderen(uitstapID);
        }
    }
}
