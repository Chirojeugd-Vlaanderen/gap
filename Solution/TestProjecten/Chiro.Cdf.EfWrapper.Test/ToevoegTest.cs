...
namespace Chiro.Cdf.Data.Test
{
	...
	public class ToevoegTest
	{
		...
		public void EntityToevoegenViaAttachEntityGraph()
		{
			...
			GelieerdePersoon p = new GelieerdePersoon
			{
				ChiroLeefTijd = 1
			};
			int nieuwID;
		...
		public void VolledigeGraafToevoegen_VeelNaar1()
		{
			...
			PersoonsAdres pa1 = new PersoonsAdres
			{
				GelieerdePersoon = p,
				Adres = a1,
				Opmerking = "Eerste adres",
				IsStandaard = true
			};
		...
		public void VolledigeGraafToevoegen()
		{
			...
			PersoonsAdres pa2 = new PersoonsAdres
			{
				GelieerdePersoon = p,
				Adres = a2,
				Opmerking = "Tweede adres",
				IsStandaard = false
			};
