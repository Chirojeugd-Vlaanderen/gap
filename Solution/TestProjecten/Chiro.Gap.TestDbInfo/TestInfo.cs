namespace Chiro.Gap.TestDbInfo
{
	...
	public static class TestInfo
	{
        ...
        public const int GELIEERDE_PERSOON_ID = 227268; // Persoon Jos Bosmans
        public const int GELIEERDE_PERSOON2_ID = 227269; // Persoon Irène Bosmans
        public const int GELIEERDE_PERSOON3_ID = 227270; // Persoon Eugène Bosmans
        public const int GELIEERDE_PERSOON4_ID = 227271; // Persoon Yvonne Bosmans
        public const int GELIEERDE_PERSOON5_ID = 227272; // Persoon Benjamin De Kleine
        public const int MIN_AANTAL_GEL_PERS = 5;
        public const int LID3_ID = 424454;
        public const int LID4_ID = 424455;
        public const int LID5_ID = 424457;
        public const int CATEGORIE_ID = 920;
        public const string CATEGORIE_CODE = "last";
        public const int CATEGORIE2_ID = 921;
        public const int CATEGORIE3_ID = 922;
        public const int FUNCTIE_ID = 421;
        public const int AANTAL_IN_CATEGORIE = 1;
        public const int AFDELING1_ID = 5872;
        public const int OFFICIELE_AFDELING_ID = 1;
        public const int AFDELINGS_JAAR1_ID = 23266;
        public const int AFDELING1_VAN = 2003;
        public const int AFDELING1_TOT = 2004;
        public const int AFDELING2_ID = 5873;
        public const int AFDELINGS_JAAR2_ID = 23267;
        public const int AFDELING2_VAN = 2003;
        public const int AFDELING2_TOT = 2004;
        public const int AFDELING3_ID = 5874;
        public const int ADRES_ID = 53;
        public const int GROEPS_WERKJAAR_ID = 5042;
