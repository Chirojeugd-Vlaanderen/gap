...
namespace Chiro.Gap.Workers.Test
{
    ...
    public class LedenManagerTest
    {
        ...
        /// <summary>
        /// InschrijvingVoorstellen moet weigeren een voorstel te doen voor een persoon zonder adres.
        ///</summary>
        [TestMethod()]
        [ExpectedFoutNummer(typeof(FoutNummerException), FoutNummer.AdresOntbreekt)]
        public void InschrijvingVoorstellenZonderAdresTest()
        {
            // Arrange
            // Ik maak een persoon, en een werkjaar met 2 afdelingen.  Maar dat is hier
            // niet relevant. Wat wel van belang is, is dat de persoon te jong is om
            ...
            // We moeten hier niets asserten, want we verwachten een exception.
        }
